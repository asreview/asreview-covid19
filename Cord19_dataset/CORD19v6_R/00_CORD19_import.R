#Add dates to CORD19 dataset (v6 dd 20200403)
...
#CORD19 <- seeCORDfull(url6)


#read selected columns
#warnings on date column are expected, only properly formatted dates are included 
CORD19id <- getCORDid(url6)
#47298 records 

#explore duplicates
#test <- CORD19id %>%
#  distinct()
#47298 unique records (based on ids present)



# set filename + location for read/write
filename <- "CORD19v6_R/data/CORD19id.csv"
