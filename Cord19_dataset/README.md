...
This information is available as separate dataset [CORD19id_date.csv](CORD19v5_R/output/CORD19id_date.csv) containing the following variables:  
...
This subset is available as a separate dataset [CORD19_201912.csv](CORD19v5_R/output/CORD19_201912.csv) containing the following variables:  
